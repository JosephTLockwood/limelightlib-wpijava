...
public class LimelightHelpers {
  ...
  public record PoseEstimate(
      ...
      boolean isMegaTag2) {
    /** Creates a PoseEstimate with default values. */
    public PoseEstimate() {
      this(new Pose2d(), 0, 0, 0, 0, 0, 0, new RawFiducial[] {}, false);
    }

    /** Checks if this PoseEstimate is valid. */
    public boolean isValid() {
      return pose != null && rawFiducials != null && rawFiducials.length != 0;
    }
    ...
    public String toString() {
      ...
      if (!isValid()) {
        sb.append("No RawFiducials data available.");
        return sb.toString();
      }
      sb.append(
          String.format(
      ...
      for (int i = 0; i < rawFiducials.length; i++) {
        ...
        sb.append(rawFiducials[i].toString().indent(2));
      }
      return sb.toString();
    }
  }
